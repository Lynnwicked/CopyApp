...
namespace CopyApp.Copy {
  public class CopyArgs {
    ...
    [ArgShortcut("m"), ArgShortcut(ArgShortcutPolicy.ShortcutsOnly), ArgDefaultValue(false), ArgDescription("Only target media files (e.g. video or audio files only)")]
    public bool Media { get; set; }

    [ArgShortcut("d"), ArgShortcut(ArgShortcutPolicy.ShortcutsOnly), ArgDefaultValue(false), ArgDescription("Delete copied source files and any empty folders found")]
